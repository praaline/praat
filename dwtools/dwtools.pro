...
INCLUDEPATH += ../kar ../LPC ../fon ../sys ../stat ../dwsys ../external/portaudio ../external/espeak ../EEG ../kar

SOURCES += \
    ActivationList.cpp AffineTransform.cpp \
    ...
    OptimalCeilingTier.cpp OptimalCeilingTierEditor.cpp \
